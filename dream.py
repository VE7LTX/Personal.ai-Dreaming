...
# Set up the API Creds, CHANGE YOUR API KEY BELOW IN MAIN STATEMENT
api_key = "PERSONAL_AI_API_KEY"


sensory_experiences = [    "the feeling of a pencil or pen in your hand, as you brainstorm and sketch out ideas on paper",    "the sound of typing out a complex command or script in a terminal or command prompt",    "the sight of a line-by-line analysis of code, searching for errors or debugging",    "the taste of a mint or chewing gum to help you concentrate while solving a problem",    "the feeling of a mouse pointer precisely selecting a difficult-to-click button or link",    "the sound of the 'ding' or 'ping' when a test case passes or fails",    "the sight of a flowchart or decision tree, mapping out the logic of a system",    "the taste of a hot cup of tea or coffee to help you stay alert during long debugging sessions",    "the feeling of a crisp and responsive keyboard, as you enter complex commands or code snippets",    "the sound of a colleague or teammate describing a problem, as you listen and offer suggestions",    "the sight of a long log file, as you scroll through looking for relevant error messages",    "the taste of a nutritious snack to keep your energy levels up during long troubleshooting sessions",    "the feeling of a touchscreen as you navigate complex system settings or parameters",    "the sound of a colleague's praise or recognition after a particularly challenging problem has been solved",    "the sight of a well-organized and documented codebase, making troubleshooting and analysis easier and more efficient"]
...
def generate_dream_sequence(prompt):
    ...
    if response.status_code == 200:
        generated_text = response_data['response']['text'].strip()
        return generated_text
    else:
        print("Error generating dream sequence:", response.status_code)
        print(response.text)
        return None
    
def vague_dream_sequence(dream_sequence):
    words = dream_sequence.split()
    num_words_to_remove = len(words) // 5
...
# Modify the Text to match your AI name designation! This section allows you to format the text prepending the dream 
def upload_dream_sequence_to_ai_memory(dream_sequence, base_url, headers):
    ...
    if response.status_code != 200:
        ...
        print(response.text)
#ADD YOUR PERSONAL AI API KEY IN HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
if __name__ == "__main__":
    base_url = 'https://api.personal.ai/v1'
    headers = {
        "Content-Type": "application/json",
        "x-api-key": "Your Keyz go here"
    }
#ADD YOUR PERSONAL AI API KEY IN HERE!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
    while True:
    ...
    "S7 - System Command (if applicable)."
        ...
        if dream_sequence:
            ...
            # Sleep for 60 seconds before generating a new dream sequence
            time.sleep(60)
